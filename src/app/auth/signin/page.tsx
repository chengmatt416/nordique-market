...
export default function SignInPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6">
      ...
      >
        <Card padding="lg" className="border-0 shadow-xl rounded-2xl">
          <motion.div
          ...
          >
            ...
            <p className="text-gray-600">登入您的 {BrandConfig.name} 帳戶</p>
          </motion.div>
          ...
          >
            登入即表示您同意我們的
            <a href="#" className="text-blue-400 hover:underline mx-1">服務條款</a>
            和
            <a href="#" className="text-blue-400 hover:underline mx-1">隱私權政策</a>
          </motion.div>
        </Card>
